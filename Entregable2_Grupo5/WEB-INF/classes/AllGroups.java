...
public class AllGroups extends HttpServlet {
    ...
    toClient.println("<TITLE>Groups</TITLE>");
    toClient.println("</HEAD>");
   ...
   toClient.println("Number of Days");
    ...
    toClient.println( "</TR>");
	 ...
	 String sql = "SELECT GroupName, CreatorName, NumberDays FROM Groups";
		...
		try {
			...
			while (result.next()) {
               ...
               /* if (sessionBool) {
				...
				toClient.println("<td><input type=\"radio\" Name=\"Group\" onclick=\"RadioButton()\"></td>");
